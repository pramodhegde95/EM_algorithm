...
if __name__ == "__main__":
    ...
    gausian2.k=k
    gausian2.e=e;
    prob, mean, sigmas, log_likelihoods = gausian2.em_calc(varience)
    print("Final Mean:",mean.reshape(1,-1))
    print("Final Variance 0:",sigmas.reshape(1,-1))
    print("Number of iterations:",len(log_likelihoods))
    print("Log likelihood list : ",log_likelihoods)
    ...
    gausian3.k=k
    gausian3.e=e;
    prob, mean, sigmas, log_likelihoods = gausian3.em_calc(varience)
    print("Final Mean:",mean.reshape(1,-1))
    print("Final Variance 0:",sigmas.reshape(1,-1))
    print("Number of iterations:",len(log_likelihoods))
    print("Log likelihood list : ",log_likelihoods)
    ...
    gausian1.k=k
    gausian1.e=e;
    prob, mean, sigmas, log_likelihoods = gausian1.em_calc(varience)
    print("Final Mean:",mean.reshape(1,-1))
    print("Final Variance 1:",sigmas.reshape(1,-1))
    print("Number of iterations:", len(log_likelihoods))
    print("Log likelihood list : ",log_likelihoods)
    ...
    gausian4.k=k
    gausian4.e=e;
    prob, mean, sigmas, log_likelihoods = gausian4.em_calc(varience)
    print("Final Mean:",mean.reshape(1,-1))
    print("Final Variance 1:",sigmas.reshape(1,-1))
    print("Number of iterations:", len(log_likelihoods))
    print("Log likelihood list : ",log_likelihoods)
    ...
    gausian5.k=k
    gausian5.e=e;
    prob, mean, sigmas, log_likelihoods = gausian5.em_calc(varience)
    print("Final Mean:",mean.reshape(1,-1))
    print("Final Variance 1:",sigmas.reshape(1,-1))
    print("Number of iterations:", len(log_likelihoods))
    print("Log likelihood list : ",log_likelihoods)
